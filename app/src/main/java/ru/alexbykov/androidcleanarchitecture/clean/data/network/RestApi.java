...
import ru.alexbykov.androidcleanarchitecture.clean.data.network.enpoints.User;
import ru.alexbykov.androidcleanarchitecture.system.Const;
...
public class RestApi {
    ...
    public RestApi(TokenHelper preferenceHelper) {
        ...
        retrofit = new Retrofit.Builder().baseUrl(Const.Api.URL_TEST)
                .client(client)
    ...
    public final String getServer() {
        ...
        if (url.equals(Const.Api.URL_PRODACTION)) return "Prodaction";
        else return "Test";
    }


//
//    public Single<UserDTO> mockRequest() {
//
////        return new Si
//    }
